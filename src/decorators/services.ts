 ...
 * ```
 */
export function Security(roles?: string | Array<string>, name?: string): any {
    return () => { return; };
 ...
 */
export function AcceptLanguage(...languages: Array<string>): any {
    return () => { return; };
 ...
 */
export function Accept(...accepts: Array<string>): any {
    return () => { return; };
 ...
 */
export function Abstract(...args: Array<any>): any {
    return () => { return; };
