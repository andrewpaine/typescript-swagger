...
export function PathParam(name: string): any {
  ...
  */
  export function FileParam(name: string): any {
    return () => { return; };
  }
  ...
  * argument on addAvatar method's call.
  */
  export function FilesParam(name: string): any {
    return () => { return; };
  }
  ...
  */
  export function HeaderParam(name: string): any {
    return () => { return; };
  }
  ...
  */
  export function CookieParam(name: string): any {
    return () => { return; };
  }
  ...
  * method's call.
  */
  export function FormParam(name: string): any {
    return () => { return; };
  }
